      ...
      <div className="w-2/3">
        <div>
          ...
          <div className="flex justify-between text-gray-400 -mt-1 text-sm">
            ...
            <div onClick={()=>  onChange(1)}  className="px-2 cursor-pointer hover:bg-gray-100 rounded-full ml-1" >1</div>
            ...
            <div onClick={()=>  onChange(10)} className="px-2 cursor-pointer hover:bg-gray-100 rounded-full -mr-3" >10</div>
          </div>
          {/* <p>{sliderValue}</p> */}
        </div>
      </div>
